...
import jtemp.bingossorder.utils.DateUtil;
...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
	...
	public void setState(int state) {
		...
		switch(state){
            case STATE_NORMAL:
                ...
                mStatusTextView.setText(R.string.recyclerheader_hint_normal);
                break;
            case STATE_RELEASE_TO_REFRESH:
                if (mState != STATE_RELEASE_TO_REFRESH) {
                    mArrowImageView.clearAnimation();
                    mArrowImageView.startAnimation(mRotateUpAnim);
                    mStatusTextView.setText(R.string.recyclerheader_header_hint_release);
                }
                break;
            case     STATE_REFRESHING:
                mStatusTextView.setText(R.string.recyclerheader_refreshing);
                break;
            case    STATE_DONE:
                mStatusTextView.setText(R.string.recyclerheader_refresh_done);
                break;
            default:
		}
	...
	public void refreshComplete(){
        mHeaderTimeView.setText(DateUtil.convertTime(new Date().getTime()));
        setState(STATE_DONE);
