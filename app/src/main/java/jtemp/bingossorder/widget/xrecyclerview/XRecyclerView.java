...
public class XRecyclerView extends RecyclerView {
    ...
    private void init() {
        ...
        mFootViews.get(0).setVisibility(INVISIBLE);
    ...
    public void loadMoreComplete(boolean isLoadMore) {
        ...
        if (footView instanceof LoadingMoreFooter) {
            ...
            footView.setVisibility(View.VISIBLE);//in
        }
        if(!isLoadMore)
            this.scrollBy(0,-footView.getHeight());
    }
...
//                        Log.i("getVisibleHeight", " mRefreshHeader.getState() = " + mRefreshHeader.getState());
                ...
                if(isOnbuttom()&&!loadingMoreEnabled){
    ...
    private class WrapAdapter extends Adapter<ViewHolder> {
        ...
        public void onViewAttachedToWindow(ViewHolder holder) {
            ...
            if (lp != null
                    ...
                    && (isHeader(holder.getPosition()) || isFooter(holder.getPosition()))) {//
        ...
        public void onViewRecycled(ViewHolder holder) {
            if(!(holder instanceof SimpleViewHolder)&&holder!=null){
