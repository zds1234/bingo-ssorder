 ...
 * This file or any portions of it, is Copyright (C) 2012, Teksoft , http://www.teksoftco.com . All rights reserved.
 ...
 * @purpose 
 * 
 * (C) 2013 Radu Motisan , radu.motisan@gmail.com  , All rights reserved.
 *
 */
...
public class DeleteZone extends ImageView implements DropTarget {
	...
	private void init(){
		setId(R.id.delete_zone_view);
		setImageResource(R.drawable.eunut_grid_view_delete_zone_selector);
		setBackgroundResource(R.color.delete_zone_bg);
	}
	...
	public void onDrop(DragSource source, int x, int y, int xOffset, int yOffset, DragView dragView, Object dragInfo) {
		// View v = (View)source;if (isEnabled ()) toast
		// ("Moved to trash:"+v.getId());
	}
