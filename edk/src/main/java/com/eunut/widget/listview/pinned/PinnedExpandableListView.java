...
public class PinnedExpandableListView extends ExpandableListView {
	...
	private BasePinnedExpandableListAdapter mAdapter;
	...
	public void setAdapter(BasePinnedExpandableListAdapter adapter) {
		super.setAdapter(adapter);
		mAdapter = (BasePinnedExpandableListAdapter) adapter;
	}
