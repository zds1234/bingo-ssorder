...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.LinePageIndicatorStyle);
    }
	...
	public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLineWidth = a.getDimension(R.styleable.LinePageIndicator_line_width, defaultLineWidth);
        mGapWidth = a.getDimension(R.styleable.LinePageIndicator_gap_width, defaultGapWidth);
