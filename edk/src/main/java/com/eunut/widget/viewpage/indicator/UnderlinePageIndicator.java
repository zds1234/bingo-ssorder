...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.UnderlinePageIndicatorStyle);
    }
	...
	public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        setFades(a.getBoolean(R.styleable.UnderlinePageIndicator_fade, defaultFades));
        setSelectedColor(a.getColor(R.styleable.UnderlinePageIndicator_selectedColor, defaultSelectedColor));
        setFadeDelay(a.getInteger(R.styleable.UnderlinePageIndicator_fade_delay, defaultFadeDelay));
        setFadeLength(a.getInteger(R.styleable.UnderlinePageIndicator_fade_length, defaultFadeLength));
