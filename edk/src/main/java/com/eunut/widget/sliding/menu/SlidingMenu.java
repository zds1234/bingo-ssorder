package com.eunut.widget.sliding.menu;
...
import com.eunut.widget.sliding.menu.CustomViewAbove.OnPageChangeListener;
...
public class SlidingMenu extends RelativeLayout {
	...
	public SlidingMenu(Context context, AttributeSet attrs, int defStyle) {
		...
		int mode = ta.getInt(R.styleable.SlidingMenu_direction, LEFT);
		setMode(mode);
