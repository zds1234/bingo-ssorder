package com.eunut.widget.sliding.menu.app;
...
import com.eunut.widget.sliding.menu.SlidingMenu;
...
public class SlidingActivityHelper {
	...
	public void onCreate(Bundle savedInstanceState) {
		mSlidingMenu = (SlidingMenu) LayoutInflater.from(mActivity).inflate(R.layout.eunut_slidingmenu, null);
	}
