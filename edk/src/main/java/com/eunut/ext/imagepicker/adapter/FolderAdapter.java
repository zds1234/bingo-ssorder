...
public class FolderAdapter extends BaseAdapter {
    ...
    public FolderAdapter(Activity activity, List<ImageFolder> folders) {
        mActivity = activity;
    ...
    public int getItemViewHeight() {
        View itemView = mInflater.inflate(R.layout.eunut_item_folder, null);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.eunut_item_folder, parent, false);
