package com.eunut.ext.imagepicker.adapter;
...
public class AlbumAdapter extends BaseAdapter {
    ...
    public AlbumAdapter(Activity activity, ArrayList<ImageItem> images) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemViewType == ITEM_TYPE_CAMERA) {
            convertView = LayoutInflater.from(mActivity).inflate(R.layout.eunut_item_camera, parent, false);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (PermissionUtil.with(mActivity).check(Manifest.permission.CAMERA)) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(mActivity).inflate(R.layout.eunut_item_album, parent, false);
                convertView.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mImageSize)); //让图片是个正方形
            ...
            holder.cbCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (holder.cbCheck.isChecked() && mSelectedImages.size() >= selectLimit) {
                        Toast.makeText(mActivity, mActivity.getString(R.string.select_limit, selectLimit), Toast.LENGTH_SHORT)
                            .show();
